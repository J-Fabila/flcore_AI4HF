...
def _log_api_usage_once(obj: Any) -> None:
    ...
    manually subscribes a logger via the `SetAPIUsageLogger method <https://github.com/pytorch/pytorch/blob/eb3b9fe719b21fae13c7a7cf3253f970290a573e/c1>
...
class ResNet(nn.Module):
    ...
    def load_model(self,input_file):
        torch.load(input_file)

def _resnet(n_classes, block: Type[Union[BasicBlock, Bottleneck]],layers: List[int]):
